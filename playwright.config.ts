...
export default defineConfig({
  ...
  webServer: {
    // ponytail: strictPort 대신 희귀 포트. 기본 4321 이 점유되면 Astro 가 4322 로 옮기고
    // Playwright 는 4321 을 영원히 기다린다(실제 발생). 충돌 재발하면 vite.preview.strictPort 검토
    command: 'npx astro preview --outDir .test-dist --port 43210',
